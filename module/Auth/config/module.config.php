...
return array(
	...
	'view_manager' => array(
        ...
        // Dzięki temu mamy możliwość zwracania danych w postaci Json-a
        'strategies' => array(
            'ViewJsonStrategy',
        )
	),
    ...
    'doctrine' => array(
        ...
        'authentication' => array( // this part is for the Auth adapter from DoctrineModule/Authentication
            'orm_default' => array(
                ...
                'credential_property' => 'userPassword', // 'password',
                'credential_callable' => function(Entity\User $user, $passwordGiven) { 
					...
					if ($user->getUserPassword() == md5('aFGQ475SDsdfsaf2342' . $passwordGiven . $user->getUserPasswordSalt()) && $user->getUserActive() == 1)
					{
						return true;
					}
					else 
